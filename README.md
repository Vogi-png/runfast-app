# Runfast: Saúde, Treino e Performance


![Status do Projeto](https://img.shields.io/badge/status-em%20desenvolvimento-yellow?style=for-the-badge)
###
![Tamanho do Repositório](https://img.shields.io/github/repo-size/Vogi-png/runfast-app?style=for-the-badge)
![Linguagens Utilizadas](https://img.shields.io/github/languages/count/Vogi-png/runfast-app?style=for-the-badge)
![Forks](https://img.shields.io/github/forks/Vogi-png/runfast-app?style=for-the-badge)
[![Versão](https://img.shields.io/badge/Versão-1.0.0-blue?style=for-the-badge)](https://github.com/Vogi-png/runfast-app/releases)

<br/>


> Runfast é um ecossistema de saúde desenvolvido para Android, focado no monitoramento de treinos, controle de metas de peso e análise de evolução física. Unindo uma interface intuitiva (UI/UX) a um back-end robusto, o app transforma dados brutos de rotina em informações acionáveis para o usuário.
---
